---
title: "What is Tailwind CSS and why you should learn It in 2020"
...
seo:
  {
    title: "What is Tailwind CSS and why you should learn It in 2020",
    description: "Tailwind CSS is a wrapper around low-level CSS utilities with which to create custom designed sites without having to modify any vendor-specific styles.",
  }
---
...
<Image
  alt="Statistics on the use of CSS frameworks in 2019"
  height={636}
  responsive={[
    {
      size: {
...
<Image
  alt="Using Tailwind CSS as a CSS framework"
  height={415}
  responsive={[
    {
      size: {
